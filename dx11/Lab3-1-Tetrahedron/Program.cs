...
namespace Lab_3_1 {
    ...
    public Tetrahedron(IntPtr hInstance) : base(hInstance) {
        ...
        MainWindowCaption = "Lab3 - Tetrahedron";
    ...
    private void BuildGeometryBuffers() {
        var vertices = new[] {
            new VertexPC(new Vector3(-1.0f, -1.0f, -1.0f), Color.Green),
            new VertexPC(new Vector3(1.0f, -1.0f, -1.0f), Color.Green),
            new VertexPC(new Vector3(-1.0f, 1.0f, -1.0f), Color.Green),
            new VertexPC(new Vector3(-1.0f, 1.0f, -1.0f), Color.Red),
            new VertexPC(new Vector3(-1.0f, -1.0f, 1.0f), Color.Red),
            new VertexPC(new Vector3(-1.0f, -1.0f, -1.0f), Color.Red),
            new VertexPC(new Vector3(-1.0f, 1.0f, -1.0f), Color.Yellow),
            new VertexPC(new Vector3(1.0f, -1.0f, -1.0f), Color.Yellow),
            new VertexPC(new Vector3(-1.0f, -1.0f, 1.0f), Color.Yellow),
            new VertexPC(new Vector3(-1.0f, -1.0f, 1.0f), Color.Blue),
            new VertexPC(new Vector3(1.0f, -1.0f, -1.0f), Color.Blue),
            new VertexPC(new Vector3(-1.0f, -1.0f, -1.0f), Color.Blue),
        };
